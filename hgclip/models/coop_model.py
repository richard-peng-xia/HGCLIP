...
class CoOp_CLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        tokenized_prompts = self.tokenized_prompts # [n_cls, ctx_length]
        text_features = self.text_encoder(prompts, tokenized_prompts) # [n_cls, ctx_dim]
        ...
        elif self.args.dataset == 'caltech-256':
            logits_l1 = logits[:,:5]
            logits_l2 = logits[:,5:122]
            logits_l3 = logits[:,122:]
